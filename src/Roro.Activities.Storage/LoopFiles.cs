...
namespace Roro.Activities.Storage
{
    public class LoopFiles : ILoop
    {
        ...
        public Output<string> NameWithoutExtension { get; set; }

        public Output<string> Extension { get; set; }

        public Output<string> ParentDirectoryName { get; set; }

        public Output<string> FullName { get; set; }

        public Output<decimal> Length { get; set; }

        public Output<bool> IsReadOnly { get; set; }
        ...
        public void Execute(object current)
        {
            ...
            SetOutput(this.NameWithoutExtension, dataRow);
            SetOutput(this.Extension, dataRow);
            SetOutput(this.ParentDirectoryName, dataRow);
            SetOutput(this.FullName, dataRow);
            SetOutput(this.Length, dataRow);
            SetOutput(this.IsReadOnly, dataRow);
